...
import blurBg from '../mobile/src/assets/bg-blur.png'
import Stripes from '../mobile/src/assets/stripes.svg'
import NLWLogo from '../mobile/src/assets/nlw-spacetime-logo.svg'
import { styled } from 'nativewind';

//para permitir o uso de className em componentes não nativos do react
...
export default function App() {
  ...
  //enquanto não carregar o pacote de fontes, não é exibido nenhum texto na tela
  if(!hasLoadedFonts){
    return null
  }
